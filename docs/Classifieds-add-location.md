...
You can also add locations by importing them. Use  [this example file](https://raw.githubusercontent.com/yclas/yclas/master/install/samples/import/locations.csv)  to create yours and simply import locations into your website. For more information, follow  [this guide.](Classifieds-how-to-import-tool-for-categories-and-location.md)
